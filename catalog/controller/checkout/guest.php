...
class ControllerCheckoutGuest extends Controller {
	...
	public function validate() {
		...
		if (!$json) {
			...
			if ($city_info) {
				$this->session->data['guest']['payment']['city'] = $city_info['name'];
				$this->session->data['guest']['payment']['city_code'] = $city_info['code'];
			} else {
				$this->session->data['guest']['payment']['city'] = '';
				$this->session->data['guest']['payment']['city_code'] = '';
			}
			...
			if ($this->session->data['guest']['shipping_address']) {
				...
				// tokoonline
				if ($city_info) {
					$this->session->data['guest']['shipping']['city'] = $city_info['name'];
					$this->session->data['guest']['shipping']['city_code'] = $city_info['code'];
				} else {
					$this->session->data['guest']['shipping']['city'] = '';
					$this->session->data['guest']['shipping']['city_code'] = '';
				}
