		...
		if ($this->user->isLogged() && $this->user->hasPermission('modify', 'sale/order')) {	
			...
			if ($this->cart->hasShipping()) {		
				...
				if (!isset($json['error']['shipping'])) {
                    ...
                    // tokoonline
					$city_info = $this->model_localisation_city->getCity($this->request->post['shipping_city_id']);
					...
					$address_data = array(
                        ...
                        // tokoonline
						'city_id'        => $this->request->post['shipping_city_id'],
						'city'           => $city,
						'city_code'      => $city_code,
			...
			if (!isset($json['error']['payment'])) {
				...
				// tokoonline
				$city_info = $this->model_localisation_city->getCity($this->request->post['payment_city_id']);
				...
				$address_data = array(
                    ...
                    // tokoonline
					'city_id'        => $this->request->post['payment_city_id'],
					'city'           => $city,
					'city_code'      => $city_code,
