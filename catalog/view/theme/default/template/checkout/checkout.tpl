	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				// tokoonline
				if (json['error']['city']) {
					$('#payment-address select[name=\'city_id\'] + br').after('<span class="error">' + json['error']['city'] + '</span>');
				}
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				// tokoonline
				if (json['error']['city']) {
					$('#payment-address select[name=\'city_id\']').after('<span class="error">' + json['error']['city'] + '</span>');
				}
			} else {
				<?php if ($shipping_required) { ?>
				$.ajax({
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				// tokoonline
				if (json['error']['city']) {
					$('#shipping-address select[name=\'city_id\']').after('<span class="error">' + json['error']['city'] + '</span>');
				}
			} else {
				$.ajax({
					url: 'index.php?route=checkout/shipping_method',
