  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <table class="form">
      <tr>
        ...
        <td><input type="text" name="to_name" value="<?php echo $to_name; ?>" size="50" />
      ...
      <tr>
        ...
        <td><input type="text" name="to_email" value="<?php echo $to_email; ?>" size="50" />
      ...
      <tr>
        ...
        <td><input type="text" name="from_name" value="<?php echo $from_name; ?>" size="50" />
      ...
      <tr>
        ...
        <td><input type="text" name="from_email" value="<?php echo $from_email; ?>" size="50" />
      ...
      <tr>
        ...
        <td><textarea name="message" cols="50" rows="10"><?php echo $message; ?></textarea></td>
      </tr>
      <tr>
