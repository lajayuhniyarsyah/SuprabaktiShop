<?php echo $header; ?>
<h1 style="background: url('view/image/installation.png') no-repeat;">Step 2 - Pre-Instalasi</h1>
<div style="width: 100%; display: inline-block;">
  <div style="float: left; width: 569px;">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <p>1. Tolong ubah setting PHP supaya memenuhi syarat-syarat di bawah ini.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table width="100%">
          <tr>
            <th width="35%" align="left"><b>Setting PHP</b></th>
            <th width="25%" align="left"><b>Sekarang</b></th>
            <th width="25%" align="left"><b>Seharusnya</b></th>
      ...
      <p>2. Tolong pastikan PHP extension di bawah ini terinstall.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table width="100%">
          <tr>
      ...
      <p>3. Tolong pastikan file-file di bawah ini bisa ditulisi.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table width="100%">
          <tr>
      ...
      <p>4. Tolong pastikan folder-folder di bawah ini bisa ditulisi.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table width="100%">
          <tr>
