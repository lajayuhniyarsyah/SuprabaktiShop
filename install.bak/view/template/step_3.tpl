...
<div style="width: 100%; display: inline-block;">
  <div style="float: left; width: 569px;">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <p>1. Tolong isi konfigurasi database anda.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table>
          ...
          <tr>
            <td><span class="required">*</span>Nama Database:</td>
          ...
          <tr>
            <td>Prefix Database:</td>
            <td><input type="text" name="db_prefix" value="<?php echo $db_prefix; ?>" /></td>
          </tr>
        </table>
      </div>
      <p>2. Tolong isi username dan password untuk administrator.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table>
          <tr>
