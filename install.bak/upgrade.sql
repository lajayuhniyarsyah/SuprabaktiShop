...
ALTER TABLE `oc_address` ADD `city_id` int(11) NOT NULL;
ALTER TABLE `oc_affiliate` ADD `city_id` int(11) NOT NULL;
ALTER TABLE `oc_order` ADD `payment_city_id` int(11) NOT NULL;
ALTER TABLE `oc_order` ADD `shipping_city_id` int(11) NOT NULL;

DELETE FROM `oc_setting` WHERE (`group` = 'category') AND (`key` = 'category_module');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'category', 'category_module', 'a:4:{i:0;a:5:{s:9:"layout_id";s:1:"4";s:8:"position";s:11:"column_left";s:5:"count";s:1:"0";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}i:1;a:5:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"column_left";s:5:"count";s:1:"0";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}i:2;a:5:{s:9:"layout_id";s:2:"12";s:8:"position";s:11:"column_left";s:5:"count";s:1:"0";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}i:3;a:5:{s:9:"layout_id";s:2:"13";s:8:"position";s:11:"column_left";s:5:"count";s:1:"0";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}}', 1);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_admin_language');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_admin_language', 'id', 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_language');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_language', 'id', 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_currency_auto');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_currency_auto', 0x30, 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_currency');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_currency', 0x494452, 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_customer_group_display');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_customer_group_id');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_customer_group_id', '1', 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_customer_online');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_customer_online', '0', 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_customer_price');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_customer_price', '0', 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_voucher_min');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_voucher_min', '50000', 0);

DELETE FROM `oc_setting` WHERE (`group` = 'config') AND (`key` = 'config_voucher_max');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'config', 'config_voucher_max', '5000000', 0);

DELETE FROM `oc_setting` WHERE (`group` = 'testimonial') AND (`key` = 'testimonial_module');
INSERT INTO `oc_setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'testimonial', 'testimonial_module', 'a:1:{i:1;a:6:{s:17:"testimonial_title";a:2:{i:2;s:9:"Testimoni";i:3;s:12:"Testimonials";}s:17:"testimonial_limit";s:1:"5";s:9:"layout_id";s:1:"4";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"3";}}', 1);

DELETE FROM `oc_currency`;
INSERT INTO `oc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES (4, 'Rupiah','IDR','Rp ','','0',1.00000000,1,'2012-05-30 16:51:18');
INSERT INTO `oc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES (5, 'Dollar', 'USD', '$ ', '', '2', 0.00010352, 1, '2012-12-28 16:10:48');

DELETE FROM `oc_language`;
INSERT INTO `oc_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES (2, 'Indonesia', 'id', 'id_ID.UTF-8,id_ID,id-id,indonesia', 'id.png', 'indonesia', 'indonesia', 1, 1);
INSERT INTO `oc_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES (3, 'English', 'en', 'en_US.UTF-8.en_US,en-us,english', 'gb.png', 'english', 'english', 2, 1);

DELETE FROM `oc_customer_group`;
INSERT INTO `oc_customer_group` (`customer_group_id`, `approval`, `company_id_display`, `company_id_required`, `tax_id_display`, `tax_id_required`, `sort_order`) VALUES (1, 0, 0, 0, 0, 0, 1);

DELETE FROM `oc_customer_group_description`;
INSERT INTO `oc_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES (1, 2, 'Default', 'Default Customers');

ALTER TABLE `oc_testimonial` ADD `title` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
ALTER TABLE `oc_testimonial` ADD `description` text COLLATE utf8_unicode_ci NOT NULL;
...
CREATE VIEW `oc_cityview` AS SELECT
