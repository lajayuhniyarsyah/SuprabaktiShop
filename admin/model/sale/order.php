...
class ModelSaleOrder extends Model {
	...
	public function editOrder($order_id, $data) {
		...
		// tokoonline
		$city_info = $this->model_localisation_city->getCity($data['shipping_city_id']);
		
		if ($city_info) {
			$shipping_city = $city_info['city_name'];
		} else {
			$shipping_city = '';			
		}	
        ...
        // tokoonline
		$city_info = $this->model_localisation_city->getCity($data['payment_city_id']);
		
		if ($city_info) {
			$payment_city = $city_info['city_name'];
		} else {
			$payment_city = '';			
		}
