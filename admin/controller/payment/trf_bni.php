...
class ControllerPaymentTrfBni extends Controller {
	...
	public function index() {
		...
		$this->data['text_logo'] = $this->language->get('text_trf_bni');
		...
		$this->data['action'] = $this->url->link('payment/trf_bni', 'token=' . $this->session->data['token'], 'SSL');
		
		$this->data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSL');
		
		if (isset($this->request->post['trf_bni_accountno'])) {
			$this->data['trf_bni_accountno'] = $this->request->post['trf_bni_accountno'];
		} else {
			$this->data['trf_bni_accountno'] = $this->config->get('trf_bni_accountno');
		}
		
		if (isset($this->request->post['trf_bni_accountname'])) {
			$this->data['trf_bni_accountname'] = $this->request->post['trf_bni_accountname'];
		} else {
			$this->data['trf_bni_accountname'] = $this->config->get('trf_bni_accountname');
		}
		
		if (isset($this->request->post['trf_bni_total'])) {
			$this->data['trf_bni_total'] = $this->request->post['trf_bni_total'];
		} else {
			$this->data['trf_bni_total'] = $this->config->get('trf_bni_total');
		} 
				
		if (isset($this->request->post['trf_bni_order_status_id'])) {
			$this->data['trf_bni_order_status_id'] = $this->request->post['trf_bni_order_status_id'];
		} else {
			$this->data['trf_bni_order_status_id'] = $this->config->get('trf_bni_order_status_id');
		} 
		...
		if (isset($this->request->post['trf_bni_geo_zone_id'])) {
			$this->data['trf_bni_geo_zone_id'] = $this->request->post['trf_bni_geo_zone_id'];
		} else {
			$this->data['trf_bni_geo_zone_id'] = $this->config->get('trf_bni_geo_zone_id');
		} 
		...
		if (isset($this->request->post['trf_bni_status'])) {
			$this->data['trf_bni_status'] = $this->request->post['trf_bni_status'];
		} else {
			$this->data['trf_bni_status'] = $this->config->get('trf_bni_status');
		}
		
		if (isset($this->request->post['trf_bni_sort_order'])) {
			$this->data['trf_bni_sort_order'] = $this->request->post['trf_bni_sort_order'];
		} else {
			$this->data['trf_bni_sort_order'] = $this->config->get('trf_bni_sort_order');
		}

		$this->template = 'payment/trf_bni.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function validate() {
		...
		if (!$this->request->post['trf_bni_accountno']) {
			$this->error['accountno'] = $this->language->get('error_accountno');
		}

		if (!$this->request->post['trf_bni_accountname']) {
