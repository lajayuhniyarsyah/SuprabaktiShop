...
class ControllerPaymentTrfBri extends Controller {
	...
	public function index() {
		...
		$this->data['text_logo'] = $this->language->get('text_trf_bri');
		...
		$this->data['action'] = $this->url->link('payment/trf_bri', 'token=' . $this->session->data['token'], 'SSL');
		
		$this->data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSL');
		
		if (isset($this->request->post['trf_bri_accountno'])) {
			$this->data['trf_bri_accountno'] = $this->request->post['trf_bri_accountno'];
		} else {
			$this->data['trf_bri_accountno'] = $this->config->get('trf_bri_accountno');
		}
		
		if (isset($this->request->post['trf_bri_accountname'])) {
			$this->data['trf_bri_accountname'] = $this->request->post['trf_bri_accountname'];
		} else {
			$this->data['trf_bri_accountname'] = $this->config->get('trf_bri_accountname');
		}
		
		if (isset($this->request->post['trf_bri_total'])) {
			$this->data['trf_bri_total'] = $this->request->post['trf_bri_total'];
		} else {
			$this->data['trf_bri_total'] = $this->config->get('trf_bri_total');
		} 
				
		if (isset($this->request->post['trf_bri_order_status_id'])) {
			$this->data['trf_bri_order_status_id'] = $this->request->post['trf_bri_order_status_id'];
		} else {
			$this->data['trf_bri_order_status_id'] = $this->config->get('trf_bri_order_status_id');
		} 
		...
		if (isset($this->request->post['trf_bri_geo_zone_id'])) {
			$this->data['trf_bri_geo_zone_id'] = $this->request->post['trf_bri_geo_zone_id'];
		} else {
			$this->data['trf_bri_geo_zone_id'] = $this->config->get('trf_bri_geo_zone_id');
		} 
		...
		if (isset($this->request->post['trf_bri_status'])) {
			$this->data['trf_bri_status'] = $this->request->post['trf_bri_status'];
		} else {
			$this->data['trf_bri_status'] = $this->config->get('trf_bri_status');
		}
		
		if (isset($this->request->post['trf_bri_sort_order'])) {
			$this->data['trf_bri_sort_order'] = $this->request->post['trf_bri_sort_order'];
		} else {
			$this->data['trf_bri_sort_order'] = $this->config->get('trf_bri_sort_order');
		}

		$this->template = 'payment/trf_bri.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function validate() {
		...
		if (!$this->request->post['trf_bri_accountno']) {
			$this->error['accountno'] = $this->language->get('error_accountno');
		}

		if (!$this->request->post['trf_bri_accountname']) {
