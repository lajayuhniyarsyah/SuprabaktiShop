	...
	public function approve() {
  	...
  	private function getForm() {
		...
		foreach ($this->data['addresses'] as $i => $value) {
		    $this->data['addresses'][$i]['zones'] = $this->model_localisation_zone->getZonesByCountryId($this->data['addresses'][$i]['country_id']);
		    $this->data['addresses'][$i]['cities'] = $this->model_localisation_city->getCitiesByZoneId($this->data['addresses'][$i]['zone_id']);
        }
