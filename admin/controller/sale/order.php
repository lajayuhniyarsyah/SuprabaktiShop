...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	public function getForm() {
		...
		$this->data['shipping_zones'] = $this->model_localisation_zone->getZonesByCountryId($this->data['shipping_country_id']);															
		$this->data['payment_zones'] = $this->model_localisation_zone->getZonesByCountryId($this->data['payment_country_id']);															
		
		$this->load->model('localisation/city');
		$this->data['shipping_cities'] = $this->model_localisation_city->getCitiesByZoneId($this->data['shipping_zone_id']);															
		$this->data['payment_cities'] = $this->model_localisation_city->getCitiesByZoneId($this->data['payment_zone_id']);																
  	...
  	private function validateForm() {
        ...
        // tokoonline
    	if ($this->request->post['payment_city_id'] == '') {
      		$this->error['payment_city'] = $this->language->get('error_city');
    	}	
		...
		if ($shipping) {
            ...
            // tokoonline
			if ($this->request->post['shipping_city_id'] == '') {
