...
class ControllerCatalogTestimonial extends Controller { 
	...
	private function getList() {
		...
		$this->data['sort_title'] = HTTPS_SERVER . 'index.php?route=catalog/testimonial&token=' . $this->session->data['token'] . '&sort=title' . $url;
	...
	private function validateForm() {
		...
		if (strlen(utf8_decode($this->request->post['description'])) == 0) {
