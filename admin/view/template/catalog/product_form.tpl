...
<div id="content">
  ...
  <?php } ?>
  <!-- tokoonline -->
  <div class="success">Semua isian harga menggunakan format angka tanpa titik atau koma, contoh: <b>120000</b></div>
  <div class="box">
    <div class="heading">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <!-- tokoonline -->
              <td><input type="text" name="price" value="<?php if ($price) { echo number_format($price,0,'.',''); } ?>" /></td>
            </tr>
            <tr>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <!-- tokoonline -->
                <td class="right"><input type="text" name="product_discount[<?php echo $discount_row; ?>][price]" value="<?php echo number_format($product_discount['price'],0,'.',''); ?>" /></td>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <!-- tokoonline -->
                <td class="right"><input type="text" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo number_format($product_special['price'],0,'.',''); ?>" /></td>
