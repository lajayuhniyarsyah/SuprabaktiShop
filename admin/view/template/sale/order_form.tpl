          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="payment_zone_id">
                  <option value=""><?php echo $text_select; ?></option>
                  <?php foreach ($payment_zones as $zone) { ?>
            ...
            <tr>
              ...
              <td><select name="payment_city_id">
                  <option value=""><?php echo $text_select; ?></option>
                  <?php foreach ($payment_cities as $city) { ?>
                  <?php if ($city['city_id'] == $payment_city_id) { ?>
                  <option value="<?php echo $city['city_id']; ?>" selected="selected"><?php echo $city['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $zone['city_id']; ?>"><?php echo $city['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="shipping_city_id">
                  <option value=""><?php echo $text_select; ?></option>
                  <?php foreach ($shipping_cities as $city) { ?>
...
$('select[name=\'payment_zone_id\']').bind('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('select[name=\'payment_city_id\']').html(html);
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
...
$('select[name=\'shipping_zone_id\']').bind('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('select[name=\'shipping_city_id\']').html(html);
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
