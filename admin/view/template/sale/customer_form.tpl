          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                ...
                <td><select name="address[<?php echo $address_row; ?>][zone_id]" onchange="zone(this, '<?php echo $address_row; ?>', '<?php echo $address['city_id']; ?>');">
                    <option value=""><?php echo $text_select; ?></option>
...
function addAddress() {	
	...
	$('select[name=\'address[' + address_row + '][zone_id]\']').trigger('change');	
